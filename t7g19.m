...
if ~exist('imds','var')
    ...
    match_labels3;
    save('myImds\myImds7g19.mat','imds')
end
...
if ~exist('trainingSet','var') || ~exist('validationSet','var') || ~exist('testSet','var')
    [trainingSet,validationSet, testSet] = splitEachLabel(imds,...%0.8, 0.1, 0.1 ... 
        ...%399,49,49 ...
         100,10,10 ...
        ,'randomized');
    save('mySets\mySets7g19.mat','trainingSet','validationSet','testSet')
end
...
layers = [
    ...
    convolution2dLayer([3 3],64,'Stride',[1 1],'Padding',0,'Name','conv4')
    batchNormalizationLayer('Name','BN4')
    reluLayer('Name','relu4')
    maxPooling2dLayer([3 3],'Stride',2,'Name','MP4')
    convolution2dLayer([3 3],64,'Stride',[1 1],'Padding',0,'Name','conv5')
...
skipConv = convolution2dLayer(1,64,'Stride',2,'Name','skipConv');
lgraph = addLayers(lgraph,skipConv);
lgraph = connectLayers(lgraph,'MP1','skipConv');
lgraph = connectLayers(lgraph,'skipConv','add1/in2')
