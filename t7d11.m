...
if ~exist('trainingSet','var') || ~exist('validationSet','var') || ~exist('testSet','var')
    [trainingSet,validationSet, testSet] = splitEachLabel(imds,...%0.8, 0.1, 0.1 ...
        ...%399,49,49 
         399,50,50 ...
        ,'randomized');
    save('mySets7d11.mat','trainingSet','validationSet','testSet')
end
...
conv1=net7d10.Layers(2);
conv1.Weights=conv1.Weights+(rand(11,11,1,96)*40-20);

conv2=net7d10.Layers(5);
conv2.Weights=conv2.Weights+(rand(5,5,96,128)*0.1-0.05);

fc1=net7d10.Layers(8);
fc1.Weights=fc1.Weights+(rand(500,512)*0.1-0.05);

fc2=net7d10.Layers(12);
fc2.Weights=fc2.Weights+(rand(500,500)*0.1-0.05);

fc3=net7d10.Layers(16);
fc3.Weights=fc3.Weights+(rand(60,500)*0.1-0.05);
