...
if ~exist('imds','var')
    ...
    match_labels3;
    save('myImds\myImds7g8.mat','imds')
end
...
if ~exist('trainingSet','var') || ~exist('validationSet','var') || ~exist('testSet','var')
    [trainingSet,validationSet, testSet] = splitEachLabel(imds,...%0.8, 0.1, 0.1 ... 
        ...%399,49,49 ...
         100,10,10 ...
        ,'randomized');
    save('mySets\mySets7g8.mat','trainingSet','validationSet','testSet')
end
...
layers = [
    imageInputLayer([256 256 1],'Normalization', ...
    'none')
