%test 9 - nauczenie sieci klas ró¿nych substancji i ich stê¿eñ
%bez utraty danych przez skalowanie lub strukturê sieci
%wyko¿ystanie sekwencji klatek
reset(gpuDevice(1));
...
if ~exist('imds','var')
    ...
    match_labels4;
    save('myImds\myImds9a1.mat','imds')
end
...
if ~exist('trainingSet','var') || ~exist('validationSet','var') || ~exist('testSet','var')
    [trainingSet,validationSet, testSet] = splitEachLabel(imds,...%0.8, 0.1, 0.1 ... 
        ...%399,49,49 ...
         100,10,10 ...
        ,'randomized');
    save('mySets\mySets9a1.mat','trainingSet','validationSet','testSet')
end
...
layers = [
    ...
    convolution2dLayer([3 3],64,'Stride',[1 1],'Padding',1,'Name','conv2')
    ...
    convolution2dLayer([3 3],64,'Stride',[1 1],'Padding',1,'Name','conv5')
    ...
    %warstwa 8
    fullyConnectedLayer(62,'Name','fc3')
    %net7c15.Layers(17)
    %fc3
